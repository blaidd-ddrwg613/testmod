...
public class ModItemModelProvider extends ItemModelProvider
{
    ...
    protected void registerModels()
    {
        ...
        handheldItem((DeferredItem<Item>) ModItems.BLACK_OPAL_PAXEL);
        handheldItem((DeferredItem<Item>) ModItems.BLACK_OPAL_PICKAXE);
        handheldItem((DeferredItem<Item>) ModItems.BLACK_OPAL_SWORD);
        handheldItem((DeferredItem<Item>) ModItems.BLACK_OPAL_HAMMER);
        handheldItem((DeferredItem<Item>) ModItems.BLACK_OPAL_SHOVEL);
    }
